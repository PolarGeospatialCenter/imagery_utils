...
def getDGXmlData(xmlpath,stretch):
    ...
    if len(xmldoc.getElementsByTagName('IMD')) >=1:
        ...
        EsunDict = {  # Spectral Irradiance in W/m2/um
            ...
            'WV03_BAND_P':1580.8140,
            'WV03_BAND_C':1758.2229,
            'WV03_BAND_B':1974.2416,
            'WV03_BAND_G':1856.4104,
            'WV03_BAND_Y':1738.4791,
            'WV03_BAND_R':1559.4555,
            'WV03_BAND_RE':1342.0695,
            'WV03_BAND_N':1069.7302,
            'WV03_BAND_N2':861.2866,
