...
class TestCopyDems(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.setsm_strip_files = [
            #### strip
            "SETSM_WV01_20080830_1020010003561200_1020010004712300_1_8m_dem.geom",
            ...
            "SETSM_WV01_20080830_1020010003561200_1020010004712300_1_8m_matchtag_browse.tif",
            "SETSM_WV01_20080830_1020010003561200_1020010004712300_1_8m_ortho.tif",
            "SETSM_WV01_20080830_1020010003561200_1020010004712300_1_8m_ortho_8bit.tif",
    ...
    def test_copy_asp_strip(self):
        ...
        for f in self.asp_strip_files:
            move_file = pgc_copy_dems.check_file_inclusion(f, self.asp_pairname, overlap_prefix, self.args)
    ...
    def test_copy_setsm(self):
        ...
        for f in self.setsm_strip_files:
            move_file = pgc_copy_dems.check_file_inclusion(f, self.setsm_pairname, overlap_prefix, self.args)
            if f in files_to_move:
                self.assertTrue(move_file)
            else:
                self.assertFalse(move_file)
