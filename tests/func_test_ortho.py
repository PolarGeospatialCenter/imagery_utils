...
class TestOrthoFunc(unittest.TestCase):
    ...
    def test_image_types(self):
        ...
        test_images = [
            ...
            ('GE01_20110108171314_1016023_5V110108M0010160234A222000100252M_000500940.ntf',4326),
            ...
            ('GE01_20140402211914_1050410010473600_14APR02211914-M1BS-053720734020_01_P003.NTF',4326),
            ('WV02_20100423190859_1030010005C7AF00_10APR23190859-M2AS_R1C1-052462689010_01_P001.NTF',4326),
            ('IK01_19991222080400_1999122208040550000011606084_po_82037_pan_0000000.tif',4326),
            ...
            ('GE01_11OCT122053047-P1BS-10504100009FD100.ntf',3413), #### GE01 image wth abscalfact in W/m2/um
        ...
        for test_image,epsg in test_images:
            ...
            cmd = r"""python "%s" --wd /local -r -p %d "%s" "%s" """ %(self.scriptpath, epsg, srcfp, self.dstdir)
    ...
    def test_input_parameters(self):
        ...
        cmds = [
            ...
            r"""python "%s" --epsg 3413 --stretch ns --resample cubic --format GTiff --outtype Byte --gtiff-compression jpeg95 --dem /mnt/agic/storage00/agic/private/elevation/dem/GIMP/GIMPv2/gimpdem_v2_30m.tif %s/QB02_20120827132242_10100100101AD000_12AUG27132242-M1BS-500122876080_01_P006.NTF %s""" % (self.scriptpath, self.srcdir, self.dstdir),
            ...
            # dem: Y:/private/elevation/dem/GIMP/GIMPv2/gimpdem_v2_30m.tif
            r"""python "%s" --epsg 3413 --stretch rf --resample near --format ENVI --outtype Byte --gtiff-compression lzw --dem /mnt/agic/storage00/agic/private/elevation/dem/GIMP/GIMPv2/gimpdem_v2_30m.tif %s/QB02_20120827132242_10100100101AD000_12AUG27132242-M1BS-500122876080_01_P006.NTF %s""" % (self.scriptpath, self.srcdir, self.dstdir),
            ...
            # gtiff compression: lzw
            # dem: Y:/private/elevation/dem/GIMP/GIMPv2/gimpdem_v2_30m.tif
            r"""python "%s" --epsg 3413 --stretch mr --resample near --format HFA --outtype Float32 --gtiff-compression lzw --dem /mnt/agic/storage00/agic/private/elevation/dem/GIMP/GIMPv2/gimpdem_v2_30m.tif %s/QB02_20120827132242_10100100101AD000_12AUG27132242-M1BS-500122876080_01_P006.NTF %s""" % (self.scriptpath, self.srcdir, self.dstdir),
            ...
            # gtiff compression: lzw
            # dem: None
            r"""python "%s" --epsg 3413 --stretch rd --resample near --format GTiff --outtype UInt16 --gtiff-compression lzw %s/QB02_20120827132242_10100100101AD000_12AUG27132242-M1BS-500122876080_01_P006.NTF %s""" % (self.scriptpath, self.srcdir, self.dstdir),
        
            # dem: Y:/private/elevation/dem/RAMP/RAMPv2/ RAMPv2_wgs84_200m.tif
            # should fail: the image is not contained within the DEM
            r"""python "%s" --epsg 3413 --dem /mnt/agic/storage00/agic/private/elevation/dem/RAMP/RAMPv2/RAMPv2_wgs84_200m.tif %s/QB02_20120827132242_10100100101AD000_12AUG27132242-M1BS-500122876080_01_P006.NTF %s""" % (self.scriptpath, self.srcdir, self.dstdir)
        ]
